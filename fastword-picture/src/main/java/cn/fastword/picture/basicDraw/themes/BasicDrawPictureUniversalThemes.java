package cn.fastword.picture.basicDraw.themes;
...
public class BasicDrawPictureUniversalThemes {
    ...
    private final static Font defaultFont = new Font("黑体", Font.PLAIN, 16);
    private final static Font headerFont = new Font("黑体", Font.PLAIN, 25);
    ...
    protected static void setDefaultChartTheme() {
        ...
        pictureTheme.setRangeGridlinePaint(new Color(220, 220, 220));// Y坐标轴水平网格颜色
    ...
    protected void setYAxisThemes(CategoryPlot plot) {
        ...
        plot.setRangeGridlinePaint(new Color(220, 220, 220)); // Y轴网格线条
    ...
    public void setPieRender(Plot plot) {
        ...
        piePlot.setLabelGenerator(new StandardPieSectionLabelGenerator("{0}({1}):总占比:{2}%"));// 显示标签数据
    }
